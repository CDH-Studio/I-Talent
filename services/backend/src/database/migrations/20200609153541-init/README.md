# Migration `20200609153541-init`

This migration has been generated at 6/9/2020, 3:35:41 PM.
...
"address" text  NOT NULL ,"city" text  NOT NULL ,"country" text  NOT NULL ,"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" text  NOT NULL ,"language" "Language" NOT NULL ,"opOfficeLocationsId" text   ,"province" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,
    PRIMARY KEY ("id"))

CREATE TABLE "public"."opOfficeLocations" (
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" text  NOT NULL ,"postalCode" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,
    PRIMARY KEY ("id"))
...
"categoryId" integer  NOT NULL ,"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,
    PRIMARY KEY ("id"))

CREATE TABLE "public"."opTransCategories" (
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" SERIAL,"language" "Language" NOT NULL ,"name" text  NOT NULL ,"opCategoriesId" integer   ,"updatedAt" timestamp(3)  NOT NULL ,
    PRIMARY KEY ("id"))
...
"country" text  NOT NULL ,"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" text  NOT NULL ,"language" "Language" NOT NULL ,"name" text  NOT NULL ,"opSchoolsId" text   ,"province" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,
    PRIMARY KEY ("id"))
...
"branch" text  NOT NULL ,"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"employmentInfosId" text   ,"id" text  NOT NULL ,"jobTitle" text  NOT NULL ,"language" "Language" NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,
    PRIMARY KEY ("id"))
...
"competencyId" text  NOT NULL ,"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" text  NOT NULL ,"skillId" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,"userId" text  NOT NULL ,
    PRIMARY KEY ("id"))
...
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"date" timestamp(3)  NOT NULL ,"id" text  NOT NULL ,"proficiency" "Proficiency" NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,"userId" text  NOT NULL ,
    PRIMARY KEY ("id"))
...
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"description" text  NOT NULL ,"experiencesId" text   ,"id" text  NOT NULL ,"jobTitle" text  NOT NULL ,"lagnauge" "Language" NOT NULL ,"organization" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,
    PRIMARY KEY ("id"))
...
CREATE UNIQUE INDEX "opTransOfficeLocations.language_address_province" ON "public"."opTransOfficeLocations"("language","address","province")
...
CREATE UNIQUE INDEX "opTransSchools.language_country_name_province" ON "public"."opTransSchools"("language","country","name","province")

CREATE UNIQUE INDEX "opTransDiplomas.language_description" ON "public"."opTransDiplomas"("language","description")
...
CREATE UNIQUE INDEX "transOrganizations.language_description" ON "public"."transOrganizations"("language","description")
...
CREATE UNIQUE INDEX "transExperiences.description_jobTitle_organization" ON "public"."transExperiences"("description","jobTitle","organization")
...
ALTER TABLE "public"."developmentalGoals" ADD FOREIGN KEY ("skillId")REFERENCES "public"."opSkills"("id") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "public"."developmentalGoals" ADD FOREIGN KEY ("competencyId")REFERENCES "public"."opCompetencies"("id") ON DELETE CASCADE  ON UPDATE CASCADE
...
ALTER TABLE "public"."users" ADD FOREIGN KEY ("visibleCardId")REFERENCES "public"."visibleCards"("id") ON DELETE SET NULL  ON UPDATE CASCADE
```
...
+  country       String
+
+  @@unique([language, address, province])
+}
+
...
+  province    String
+
+  @@unique([language, country, name, province])
+}
+
+model opSchools {
+  id            String      @default(uuid()) @id
...
+  skills    opSkills @relation(fields: [skillId])
+
...
+  users         users           @relation(fields: [userId])
+  skills        opSkills        @relation(fields: [skillId])
+  competencies  opCompetencies  @relation(fields: [competencyId])
+
...
+  
+
+  @@unique([description, jobTitle, organization])
+}
+
+model experiences {
+  id           String    @default(uuid()) @id
...
+
+  user       users             @relation(fields: [userId])
+  locations  opOfficeLocations @relation(fields: [locationId])
+
