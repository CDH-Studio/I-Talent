# Migration `20210507144114-remove-acting-date`

This migration has been generated at 5/7/2021, 10:41:14 AM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE "User" DROP COLUMN "actingStartDate",
DROP COLUMN "actingEndDate"
```
...
migration 20210503153626-optional-qualified-pool-fields..20210507144114-remove-acting-date
--- datamodel.dml
+++ datamodel.dml
@@ -3,9 +3,9 @@
 }
