      ...
      {locale === "ENGLISH" ? (
        <>
          ...
          <p>
            ...
            information collected will be retained and disposed of in accordance
            with the ISED retention and disposal schedule.
          </p>
          <p>
          ...
          <p>
            ...
            privacy related information and your responsibility when entering
        ...
        <>
          <p>
            Veuillez noter qu&apos;en vous connectant, vous avez la possibilité
            de auto-administrer des informations vous concernant. La collection
            de votre les informations auto-administrées sont appelées vos
            informations de profil pour mettre en valeur votre histoire
            professionnelle. Vous pourrez contrôler qui et quelles informations
            les membres I-Talent d&apos;ISDE peuvent voir dans votre paramètres
            de profil.
          </p>
          <p>
          ...
          <p>
            ...
            responsable de toutes les informations de votre profil que vous avez
            auto-administré.
          </p>
          <p>
          ...
          <p>
            ...
            pour informations supplémentaires relatives à la confidentialité et
            votre responsabilité lors de la saisie des informations de votre
            profil.
          </p>
          <p>
            Si vous avez besoin de clarification ou de plus d&apos;informations
            sur les problèmes de confidentialité et la Loi sur la protection des
            renseignements personnels, vous pouvez contacter nos services AIPRP
            à atip-aiprpa.ic@canada.ca.
          </p>
          <p>
            En soumettant vos informations, vous confirmez que vous avez accédé
            à cette déclaration de confidentialité et à cette clause de
